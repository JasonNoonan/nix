...
- liveview: Elixir LiveView project setup
- ash: Elixir LiveView + Ash Framework setup, using Igniter
...
- Package manager setup (npm/yarn/pnpm for react|node.js, mix for Elixir|LiveView)
- Version management (.nvmrc, .python-version, asdf)
- Environment variables & .env structure
- Docker configuration if needed

Code Quality:

- TS & React: ESLint/Prettier configuration
- Elixir & LiveView: Credo configuration
- Test framework setup (Jest, Pytest, ExUnit, etc)
...
# LiveView project with GitHub Actions
/dev-setup --type liveview --ci github --tools --ultrathink
```
